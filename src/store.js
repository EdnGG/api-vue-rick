...
const store = new Vuex.Store({
  ...
  mutations: {
    ...
    // showCharacter: function (state, showCharacter) {
    //   state.showCharacter = showCharacter
    // }
  ...
  actions: {
    ...
    // showCharacter: function (context, showCharacter) {
    //   context.commit("showCharacter", showCharacter)
    // }
  }
})
